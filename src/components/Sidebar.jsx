        ...
        <div className="mb-6 pb-4 border-b border-slate-800">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-cyan-500 text-xl font-bold text-white shadow-lg shadow-emerald-500/30">
                📈
              </div>
              {!isCollapsed && (
                <div className="overflow-hidden">
                  <h2 className="text-base font-bold text-white leading-tight whitespace-nowrap">CA Eco Hub</h2>
                  <span className="text-xs font-semibold text-emerald-400 whitespace-nowrap">Paper 4 Economics</span>
                </div>
              )}
            </div>
            <button
          ...
          {navItems.map((item) => (
            <button
              ...
              className={`flex w-full items-center gap-3 rounded-xl py-3 text-sm font-medium transition-all duration-200 cursor-pointer ${
                ...
                activeTab === item.id
                  ? 'bg-gradient-to-r from-emerald-500/20 to-cyan-500/10 text-white border border-emerald-500/40 shadow-md shadow-emerald-500/10'
        ...
        <div className="mt-auto rounded-xl border border-slate-800 bg-slate-900/60 p-3.5 backdrop-blur-md">
          {isCollapsed ? (
            <div className="flex flex-col items-center gap-1 text-center">
              <span className="text-xs font-extrabold text-emerald-400">L{user.level}</span>
            ...
            <>
              ...
              <div className="h-2 w-full overflow-hidden rounded-full bg-slate-800">
                <div className="h-full rounded-full bg-gradient-to-r from-emerald-400 via-cyan-500 to-indigo-500 transition-all duration-500" style={{ width: `${progressPercent}%` }}></div>
              </div>
