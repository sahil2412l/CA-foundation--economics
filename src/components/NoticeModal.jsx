      ...
      <div className="w-full max-w-xl rounded-2xl border border-cyan-500/40 bg-slate-900 p-6 space-y-4 shadow-2xl max-h-[85vh] overflow-y-auto">
        <div className="flex justify-between items-center pb-2 border-b border-slate-800">
          <h3 className="text-lg font-bold text-white flex items-center gap-2">
            ℹ️ CA Foundation Paper 4: Economics & BCK Notice
          </h3>
        ...
        <div className="space-y-4 text-xs text-slate-300">
          <div className="p-3 rounded-xl bg-cyan-500/10 border border-cyan-500/30 text-cyan-300">
            📌 <strong>Paper 4: Business Economics & Macroeconomics / BCK</strong> (100 Marks - 2 Hours Objective MCQ Test)
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="p-3 rounded-xl bg-slate-800/80 border border-slate-700">
                ...
                <div className="text-sm font-extrabold text-cyan-400">Business Economics</div>
                <div className="text-xs text-amber-400 font-bold mt-1">50 - 60 Marks</div>
              </div>
              <div className="p-3 rounded-xl bg-slate-800/80 border border-slate-700">
                <div className="text-xs font-semibold text-slate-400">Part B</div>
                <div className="text-sm font-extrabold text-indigo-400">Macroeconomics & Policy</div>
                <div className="text-xs text-amber-400 font-bold mt-1">20 - 30 Marks</div>
              </div>
              <div className="p-3 rounded-xl bg-slate-800/80 border border-slate-700">
                <div className="text-xs font-semibold text-slate-400">Part C</div>
                <div className="text-sm font-extrabold text-emerald-400">BCK Overview</div>
                <div className="text-xs text-amber-400 font-bold mt-1:">10 - 20 Marks</div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1.5 text-slate-300">
              <li><strong>Negative Marking:</strong> Each wrong answer incurs a penalty of <span className="text-rose-400 font-bold">0.25 marks</span>.</li>
              <li><strong>Scarcity & Choice Focus:</strong> Focus heavily on Elasticity of Demand/Supply, Cost Curves & Market Structures.</li>
